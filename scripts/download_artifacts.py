...
def main():
    ...
    parser.add_argument('--model-repo', help='Model repository to use after acceptance')
    parser.add_argument('--dataset-repo', help='Dataset repository to use after acceptance')
    ...
    if (args.profile and not args.model_repo) or (args.dataset and not args.dataset_repo):
        parser.error('Checkpoints and supervision will be released after acceptance. Supply explicit repository IDs once available.')
