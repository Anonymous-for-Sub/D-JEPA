...
`index.html` is the anonymous static project page. Content, CSS and JavaScript
are specific to D-JEPA. No frontend build system, CDN, analytics or backend is required.
